      ...
      <div className="w-full max-w-sm">
        <div className="rounded-[2rem] border border-white/10 bg-slate-900/80 p-8 shadow-[0_40px_120px_rgba(2,6,23,0.6)] backdrop-blur-xl">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Your incidents are private to your account.
          </p>

          <div className="mt-8">
            <a
              href={`${getApiBase()}/auth/google`}
              className="flex w-full items-center justify-center gap-3 rounded-full border border-white/10 bg-white/5 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/10 active:scale-[0.98]"
            >
